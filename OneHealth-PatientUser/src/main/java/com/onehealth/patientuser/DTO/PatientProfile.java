package com.onehealth.patientuser.DTO;
...
public class PatientProfile {
	...
	public PatientProfile(long userId, String firstName, String lastName, String mobileNumber, String address,
	...
	public String toString() {
		return "PatientProfile [userId=" + userId + ", firstName=" + firstName + ", lastName=" + lastName
