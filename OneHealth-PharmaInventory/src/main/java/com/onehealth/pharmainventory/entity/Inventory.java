...
public class Inventory {
	...
	public Inventory(Integer inventoryId, Integer medicineId, Integer pharmaId, Integer medicineUnits, Date expDate,
			Date mfgDate, String batchNo, BigDecimal price, String packSize) {
		super();
	...
	public String toString() {
		return "Inventory [inventoryId=" + inventoryId + ", medicineId=" + medicineId + ", pharmaId=" + pharmaId
